...
export default function App() {
    ...
    const autoFillTool = defineTool({
        ...
        description: 'Auto-fill the contact form with test data',
        inputSchema: { type: 'object', properties: {}, required: [] },
        execute: () => {
            setValues({ ...values, name: 'John Doe', email: 'john@example.com' })
            return {
                content: [{ type: 'text', text: 'Form auto-filled with test data' }],
